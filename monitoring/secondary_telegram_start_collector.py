...
CONFIG_PATH = ROOT_DIR / "config" / "secondary_signals.yaml"
STATE_PATH = ROOT_DIR / "data" / "secondary_telegram_start_subscribers.json"
...
def _load_secondary_token() -> str | None:
    try:
